<template>
  <div style="z-index: 90;position: fixed;left: 0px;top: 0px;height: 100vh;width: 100vw;overflow-y: scroll;">
    <transition name="slide-fade-down-snapout" mode="out-in">
      <v-card v-if="getDonorLoaderFlag" :key="'donorLoading'" class="d-flex justify-center">
      ...
      <v-card v-else-if="donorErrorHappened" :key="'donorError'" style="height: 100vh;width: 100vw;">
