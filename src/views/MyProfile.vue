    ...
    <div>
        <div class="row">
            ...
            <div class="card col-lg-8 col-md-12 col-sm-12 ">
                ...
                <div id="accordion">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" v-model="hall"
                                            ...
                                            <option v-for="(oneHall, index) in halls" :value="index">{{ oneHall }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <button type="button" class="btn btn-warning" data-dismiss="modal"
                                            aria-label="Close" @click="hideDetails()">Cancel
                                    </button>
                                    <button type="button" class="btn btn-success"
                                            :disabled="detailsSpinner || !enableEditing" @click="saveDetailsClicked()">
                                        Save
                                    </button>
                                </div>
                                <br>
                    ...
                    <div class="card">
                        ...
                        <div>
                            <div class="card-body">
                                <div v-if="designation!=0">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">New Password: </label>
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" :disabled="!enableEditing"
                                                   v-model="newPassword">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <button v-if="designation==1" class="btn btn-outline-danger"
                                            :disabled="!enableEditing" style="width: 100%" @click="demote()">Demote this
                                        member to donor
                                    </button>
                                    <br><br>
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-success" type="button" :disabled="commentSpinner || !enableEditing"
            ...
            <div class="card col-lg-4 col-md-12 col-md-12" style="height: fit-content">
                ...
                <button :disabled="historySpinner" class="btn btn-outline-primary" @click="loadHistory()">Load history
                </button>
                <br>
